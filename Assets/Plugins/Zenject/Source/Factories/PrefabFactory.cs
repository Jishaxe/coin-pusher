...
namespace Zenject
{
        ...
        //where T : Component
    {
        ...
        public virtual T Create(UnityEngine.Object rawCommandData)
        {
            Assert.That(rawCommandData != null,
               "Null prefab given to factory create method when instantiating object with type '{0}'.", typeof(T));

            return _container.InstantiatePrefabForComponent<T>(rawCommandData);
        }
